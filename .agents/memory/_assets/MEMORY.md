...
last_updated: '2026-06-15T01:00:50+08:00'
status: stable
staleness: 0
...
- 5.5.1 documentation records Hono security repair, memory governance cleanup, and artifact rebuilds.
...
- 文件與靜態資產由 _assets 收容。
- README 與 CHANGELOG 需同步 5.5.1 修復內容。
