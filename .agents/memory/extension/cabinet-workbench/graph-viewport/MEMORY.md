...
- source:src/cabinet-graph-viewport.ts
- source:src/tests/cabinet-graph-viewport.test.ts

## Read Contract

- Read this card before editing extension.cabinet-workbench.graph-viewport tracked files or changing their ownership boundaries.
