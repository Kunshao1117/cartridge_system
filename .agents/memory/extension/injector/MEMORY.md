...
valid_scope:
  - .agents/memory/extension/injector
scopePath: null
---
# injector — Module Memory
...
- source:.agents/memory/extension/injector

## Read Contract

- Read this card before editing injector tracked files or changing their ownership boundaries.
