...
- source:src/tool-dispatcher.ts
- source:src/tool-workspace.ts
- source:src/tests/tool-dispatcher.test.ts

## Read Contract

- Read this card before editing mcp-tools.dispatcher tracked files or changing their ownership boundaries.
