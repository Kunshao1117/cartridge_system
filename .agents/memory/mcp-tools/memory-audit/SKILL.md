...
- None active. Dependency rationale: core-types, index-manager, index-manager.dep-engine, mcp-tools.tool-registry are upstream dependencies; upstream staleness must trigger review for this card.
