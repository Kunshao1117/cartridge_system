...
- source:src/memory-graph.ts
- source:src/tests/memory-graph.test.ts

## Read Contract

- Read this card before editing mcp-tools.memory-graph tracked files or changing their ownership boundaries.
