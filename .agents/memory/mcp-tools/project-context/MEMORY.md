...
- source:src/project-context-types.ts
- source:src/project-context-registry.ts
- source:src/project-context-validation.ts
- source:src/project-context-tool-shared.ts
- source:src/project-context-tools.ts
- source:src/tests/project-context.test.ts

## Read Contract

- Read this card before editing mcp-tools.project-context tracked files or changing their ownership boundaries.
