...
last_updated: '2026-06-15T01:57:00+08:00'
status: stable
staleness: 0
...
- The MCP server now reports release version 5.5.2 through both server metadata and the CLI version flag.
...
- 06: Synced MCP server metadata and CLI version to 5.5.2.
...
- 目前沒有硬性拆分阻擋。
- MCP server 目前對外版本為 5.5.2，CLI 版本查詢與測試已同步。
- 後續修改此卡時應先讀最新原始碼。
