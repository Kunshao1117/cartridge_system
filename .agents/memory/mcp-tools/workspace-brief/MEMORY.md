...
- source:src/workspace-brief.ts
- source:src/workspace-brief-summary.ts
- source:src/tests/workspace-brief.test.ts

## Read Contract

- Read this card before editing workspace-brief tracked files or changing their ownership boundaries.
